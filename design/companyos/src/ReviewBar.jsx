...
export function Guide({ scenario, load, close }) {
  ...
  return (
    <aside className="guide" aria-label="Design blueprint">
      ...
      <a href="/references/codex-layout.png" target="_blank" rel="noreferrer">
        <img
          src="/references/codex-layout.png"
          alt="Founder-selected Codex layout reference"
        />
        Open selected reference <Icon name="external" size={13} />
      </a>
      <a
        href="/references/crew-focus-before.png"
        target="_blank"
        rel="noreferrer"
      >
        Current Crew Focus baseline <Icon name="external" size={13} />
      </a>
