...
import { scenarios, layoutContract, version } from "./blueprint";
import {
  sections,
  vocabulary,
  feasibility,
    ...
    <div className="doc-layout">
      ...
      <main className="doc-main">
        ...
        <section id="feasibility">
          ...
          <p>
            Đối chiếu production code tại local HEAD a61590f2 (code giống GitHub
            main 8278d2b1; local chỉ thêm docs), prototype v0.8, toàn bộ 5 issue
            mở và danh sách 134 issue đã đóng; đọc sâu 26 issue liên quan cùng
        ...
        <section id="references">
          ...
          <div className="reference-grid">
            <a href="/references/codex-layout.png">
              <img
                src="/references/codex-layout.png"
                alt="Ảnh Codex được founder đánh dấu ba nhóm sidebar, vùng giữa và tools"
              />
              <strong>Layout Codex founder đã chọn</strong>
              <span>
                Tham chiếu bố cục, không phải yêu cầu sao chép mọi chức năng.
              </span>
            </a>
            <a href="/references/crew-focus-before.png">
              <img
                src="/references/crew-focus-before.png"
                alt="Crew Focus cũ bị chia quá nhiều cột làm hội thoại quá hẹp"
              />
              <strong>Hiện trạng Crew trước redesign</strong>
              <span>Giữ đủ chỗ cho hội thoại khi mở công cụ.</span>
            </a>
          </div>
          <p className="source-note">
