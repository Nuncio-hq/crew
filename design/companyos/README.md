...
Do not deploy it by default: the source screenshots contain private workspace context.
...
| Selected visual input                                            | [Codex reference](public/references/codex-layout.png)                                                     |
| Current app comparison                                           | [Crew Focus baseline](public/references/crew-focus-before.png)                                            |
...
kind 30621 is a project. Project-to-channel/repository grouping remains open.
