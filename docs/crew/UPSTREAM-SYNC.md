...
| `desktop/src/features/channels/ui/ChannelPane.tsx` | composer workspace selector wiring (#187); Relink folder chip sibling (#242) | retain provider + `toolbarExtraActions` only; selector and chip live in Crew-owned files |
