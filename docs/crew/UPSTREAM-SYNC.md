...
| `desktop/src-tauri/src/managed_agents/runtime.rs` | desktop passes pool idle timeout (#169) + handover/aging env (#173) | keep env injection next to `BUZZ_ACP_LAZY_POOL` |
