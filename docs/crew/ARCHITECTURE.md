...
journal schema v2: older binaries fail closed, so recovery preserves the v2
data and uses a verified compatible build rather than restoring a stale v1
database. See [the recovery runbook](TESTING.md#wiki-journal-v2-recovery) and
