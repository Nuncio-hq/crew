//! Wire regressions for Crew's advertised exact selected-invocation steer
//! contract. These execute the real adapter subprocess and run loop; the
//! focused native filter is the required RED/GREEN gate for this module.
use super::*;
