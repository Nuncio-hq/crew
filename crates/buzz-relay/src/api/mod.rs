...
pub mod relay_members {
    ...
    ///
    /// The NIP-OA signature proves owner authority on open and closed relays.
    /// Temporal conditions are evaluated against `signed_auth_created_at`;
    /// absent or invalid tags, timestamps, and conditions yield `None`.
    ...
    pub fn owner_for_nip_oa_backfill(
        ...
        membership_owner
            .or_else(|| extract_nip_oa_owner(pubkey_bytes, auth_tag, signed_auth_created_at))
    }
