...
The plan therefore escalates, rather than decides, founder decisions **D-1**
(promotion wire shape), **D-2** (whether that tag conflicts with deferred
schema), and **D-3** (where ordinary-channel promotion may create work).
