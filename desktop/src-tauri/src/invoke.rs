...
//!
//! Extracted from `lib.rs` so Tool Pane commands (#196) can land under the
//! 1000-line ratchet without a Tauri plugin invoke namespace.

use crate::archive;
use crate::builderlab::*;
use crate::commands::*;
use crate::deep_link::{acknowledge_pending_community_deep_link, take_pending_community_deep_link};
use crate::huddle;
...
/// Register every `#[tauri::command]` on the desktop builder.
#[allow(clippy::too_many_lines)]
pub fn with_handlers(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
