...
/// Deterministic source capture shared by native acceptance and signed-graph
/// fixtures. The acceptance driver passes this through the production
/// `WikiGeneration -> build_snapshot` seam instead of constructing events in
/// the test itself.
