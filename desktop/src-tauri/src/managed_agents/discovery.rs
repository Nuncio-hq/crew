...
use preset_harnesses::{preset_avatar_url, preset_catalog_entry, PRESET_HARNESSES};
...
pub fn managed_agent_avatar_url(command: &str) -> Option<String> {
    ...
    preset_avatar_url(command)
}

#[cfg(test)]
#[path = "discovery/preset_avatar_tests.rs"]
mod preset_avatar_tests;
