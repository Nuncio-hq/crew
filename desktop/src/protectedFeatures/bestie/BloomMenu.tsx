    ...
    <div className="relative h-12 w-12">
      <motion.div
        animate={{
          ...
          boxShadow: open
            ? "0 20px 25px -5px hsl(var(--floating-shadow) / 0.12), 0 8px 10px -6px hsl(var(--floating-shadow) / 0.1)"
            : "0 10px 15px -3px hsl(var(--floating-shadow) / 0.12), 0 4px 6px -4px hsl(var(--floating-shadow) / 0.1)",
