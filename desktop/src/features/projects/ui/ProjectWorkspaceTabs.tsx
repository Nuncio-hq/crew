...
import { repositoryParticipantPubkeys } from "@/features/projects/lib/projectContributorMatching";
import {
  CircleDot,
  Files as FilesIcon,
  GitCommitHorizontal,
      ...
      >
          ...
          {repositoryUnavailableState ??
            (selectedCommitHash ? (
              ...
              <ActivityPanel
                ...
                repoParticipants={repositoryParticipantPubkeys(project)}
        ...
        >
          <PullRequestsPanel
            ...
            filesCount={
              getPullRequestFilesBadgeCount(repoDiff, repoDiffLoading) ??
              undefined
            }
            forceOpenFiles={
