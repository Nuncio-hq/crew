...
// Crew: `save` receives (content, tags, added, removed, suppressLinkPreviews, eventId);
// upstream fixtures below read eventId from the sixth argument.
...
test("edit save emits unresolved identities as non-notifying mention references", async () => {
  ...
  await submitMessageEdit(
    baseOptions(
      async (content, tags, mentionPubkeys, _removed, _suppress, eventId) => {
